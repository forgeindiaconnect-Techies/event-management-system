    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/events/*/operations/incidents").hasAnyAuthority("PORTAL_ADMIN", "ORGANIZER", "COORDINATOR", "Staff", "VOLUNTEER")
                        .requestMatchers(HttpMethod.GET, "/api/events/*/operations/incidents/mine").hasAnyAuthority("PORTAL_ADMIN", "ORGANIZER", "Staff", "VOLUNTEER")
                        .requestMatchers(HttpMethod.GET, "/api/events/*/operations/incidents").hasAnyAuthority("PORTAL_ADMIN", "ORGANIZER", "COORDINATOR")
                        .requestMatchers(HttpMethod.PUT, "/api/events/*/operations/incidents/*").hasAnyAuthority("PORTAL_ADMIN", "ORGANIZER", "COORDINATOR")
