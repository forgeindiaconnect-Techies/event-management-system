...
function PageContent({ type, active }) {
  ...
  if (page === "registrations") return <TablePage id="registrations" active={active} kind="registrations"/>;
  ...
  if (page === "exhibitors") return <TablePage id="exhibitors" active={active} kind="exhibitors"/>;
  if (page === "reports") return <ReportsPage id="reports" active={active} eventMode={type === "event"}/>;
  if (page === "manage") return <ManagePage active={active}/>;
  if (page === "eventday") return <EventDayPage active={active}/>;
