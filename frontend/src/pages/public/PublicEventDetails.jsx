        ...
        <div className="row g-4">
          ...
          <div className="col-lg-4">
            <div className="event-booking-card sticky-top">
              ...
              {registrationClosed ? (
                <div className="event-registration-closed" role="alert">
                  <BsInfoCircle />
                  <div>
                    <strong>Registration is closed</strong>
                    <span>The registration deadline for this event has passed.</span>
                  </div>
                </div>
              ) : (
