    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/invitations/invite").hasAuthority("PORTAL_ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/invitations/manual").hasAuthority("PORTAL_ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/invitations").hasAuthority("SUPER_ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/invitations/portal/*").hasAuthority("PORTAL_ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/invitations/*/reject").hasAuthority("PORTAL_ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/invitations/*").hasAuthority("PORTAL_ADMIN")
